 ...
 */
	...
	$vn_facet_display_length_maximum = 15;
				...
				switch($va_facet_info["group_mode"]){
					...
					default:
						...
						if (($vn_facet_size > $vn_facet_display_length_initial) && ($vn_facet_size <= $vn_facet_display_length_maximum)) {
							...
							$vs_link_open_text = _t("%1 mehr", $vn_facet_size - $vn_facet_display_length_initial);
							$vs_link_close_text = _t("schließen", $vn_facet_size - $vn_facet_display_length_initial);
