...
<div class="row" style="clear:both;">
	<div class="<?php print ($vs_refine_col_class) ? $vs_refine_col_class : "col-sm-3 col-md-3 col-lg-3"; ?>">
		...
		<div id="bViewButtons">
			<!-- <a href="" class="help_popup_open" ><i class="fa fa-question-circle" aria-hidden="true"></i></a> -->
<?php
...
<?php 
			if($vs_sort_control_type == 'list'){
				if(is_array($va_sorts = $this->getVar('sortBy')) && sizeof($va_sorts)) {
					print "<H5 id='bSortByList'><ul><li><strong>"._t("Sortieren nach:")."</strong></li>\n";
					$i = 0;
...
?>
		<H1>
<?php
			print _t('%1 %3', $vn_result_size, ($va_browse_info["labelSingular"]) ? $va_browse_info["labelSingular"] : $t_instance->getProperty('NAME_SINGULAR'), ($vn_result_size == 1) ? _t("Ergebnis") : _t("Ergebnisse"));	
?>	
<!-- Optionen Rädchen -->
			<div class="btn-group">
...
?>
<!-- <a href="" class="help_popup_open" ><i class="fa fa-question-circle" aria-hidden="true"></i></a> 
		<button class="help_popup_open">Hilfe</button>-->
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		jQuery('#browseResultsContainer').jscroll({
			autoTrigger: true,
			loadingHtml: "<?php print caBusyIndicatorIcon($this->request).' '.addslashes(_t('Lädt...')); ?>",
			padding: 600,
