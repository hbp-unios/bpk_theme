...
?>
			<div>
				<textarea name="comment" id="addComment<?php print $vn_item_id; ?>TextArea" placeholder="Kommentar" class="form-control"></textarea>
			</div>
			<input type="submit" value="Speichern" class="pull-right btn btn-default btn-xs">
