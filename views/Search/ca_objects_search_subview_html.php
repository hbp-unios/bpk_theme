...
?>
				<span class='multisearchFullResults'><?php print caNavLink($this->request, '<span class="glyphicon glyphicon-list"></span> '._t('Erweiterte Suche nach Objekten mit diesem Suchbegriff '), '', '', 'Search', '{{{block}}}', array('search' => $vs_search)); ?></span>
<?php
				}
?>
				<!--
				<span class='multisearchSort'><?php print _t("Sortieren nach:"); ?> {{{sortByControl}}}</span>
...
?>
				<br/>
				<?php print $qr_results->get('ca_objects.idno', array('returnAsLink' => true)); ?></br></br>
				<b><?php print $qr_results->get('ca_objects.preferred_labels.name', array('returnAsLink' => true)); ?></b>
...
<?php
	...
	TooltipManager::add('#caObjectsFullResults', 'Klicken Sie hier für alle Ergbnisse');
?>
