...
?>			
	...
	<div class="filterMenuResults col-sm-10">
		...
		<div class='browseMenuBrowseSearch'>
			<form><input type="text" size="20" id="browseMenuFacetSearchInput" class="browseMenuFacetSearchInput form-control" placeholder="<?php print addslashes(_t('Eingrenzen der Facetten')); ?>"/></form>
		</div> <!--end browseMenuSearch-->
		<div class='browseMenuBrowseAll' style="border: none; background: #F1B13B;">
<?php
		print caNavLink($this->request, _t('<span style="color: #fff;">Alle %1 ansehen </span><span class="glyphicon glyphicon-arrow-right"></span>', $vs_name), 'browseMenuBrowseAll btn btn-default btn-sm', '', 'Browse', $vs_target, '');
?>
...
<?php
		...
		print _t('Keine Facetten vorhanden');
	}
?>
