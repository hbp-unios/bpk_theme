...
<body>
	<div id='errorDetails'>
		...
		<div id="content">
			<div class='error' style="margin-top: 10%;">Leider ist etwas schiefgegangen…</div>	
			<img src="/frontend/themes/default/assets/pawtucket/graphics/error_8865.jpg" width="75%" style="margin: 20px auto;display:block">
			<h3 style="text-align: center; margin-top: 24pt;"><a href="/frontend">Zurück zur Startseite</a></h3>
			<!--
